...
public class FlightController : MonoBehaviour
{
    ...
    [SerializeField] private float liftOffset = 0.06f;
    ...
    private void UpdateVelocity() {
        ...
        // lift
        velocity.y += cosPitch * cosPitch * liftOffset;
    ...
    private void UpdateRotation() {
        rb.MoveRotation(Quaternion.Euler(pitch, yaw, rb.rotation.eulerAngles.z));   
    }
